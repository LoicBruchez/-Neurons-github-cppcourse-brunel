...
constructor of our network create a tab containing the 12500 neurons 
...
connect neurons together randomly \hypertarget{classNetwork_a0a2cdb2bc8a68e83748d280212e7f48b}{\index{Network@{Network}!run\-Simulation@{run\-Simulation}}
...
{}
\end{DoxyParamCaption}
)}}\label{classNetwork_a0a2cdb2bc8a68e83748d280212e7f48b}
run the whole simulation produce a file storing when a neuron spikes and his id \begin{DoxySeeAlso}{See Also}
connect\-Two\-Neurons(size\-\_\-t val, double w) 
\end{DoxySeeAlso}
